 ...
 * @name DisplayBody
 * @type: Component
 * @desc: Creates the body for the random module.
 * 
...
module.exports.DisplayBody = (body, componentName, getRandomType, input) => {
    ...
    container.className = 'w-full flex flex-col items-center mt-4 overflow-x-hidden';
    ...
    result.className = 'opacity-0 w-full px-4 pb-2 break-all text-asoc-gold-light text-center';
