 ...
 * @module Clock
 * @type: aSocket Module
 * @desc: Start a timer or stopwatch, create alarms, compare global times, view/convert to unix, etc.
 * 
...
asoc.onLoad = async () => {
    ...
    asoc.Genesis.SetDisplayVariable( 'Clock', 'Module', asoc.UtilityManager.DeepCopy.DeepCopy(asoc.Module));
    ...
    asoc.Module._var.window = await asoc.Genesis.CreateWindow( 'Clock', 'Home', asoc.Meta.MainDisplaySettings )
